{{--
  ...
  Props:
    $variant (string, optional) – 'hero' (default) or 'compact'
--}}
@props(['variant' => 'hero'])
...
@if($variant === 'compact')
  <form action="{{ url('/hotels') }}" method="GET" class="bg-white rounded-lg shadow-md p-4">
    <div class="flex flex-wrap gap-3">
      ...
      <button
        type="submit"
        class="bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-blue-800 transition-colors flex items-center space-x-2"
      >
